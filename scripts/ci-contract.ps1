...
$requiredFiles = @(
  ...
  'docs/milestones/M4_BROWSER_RECORD_INTEGRITY_RECOVERY.md', 'docs/handoffs/M4_PLANNING_HANDOFF.md',
...
Assert-NativeSuccess 'M4 handoff validation'
& node -e @'
...
'@
Assert-NativeSuccess 'M4 handoff change-surface check'
